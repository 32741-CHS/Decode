...
public class Blue {
    ...
    // Teleop
    // Gate Start & End
    public static final Pose GATE_START_POSE = new Pose(23, 60, Math.toRadians(180));//new Pose(23, 72, Math.toRadians(180));
    public static final Pose GATE_END_POSE = new Pose(17, 60, Math.toRadians(180));//new Pose(17, 72, Math.toRadians(180));
