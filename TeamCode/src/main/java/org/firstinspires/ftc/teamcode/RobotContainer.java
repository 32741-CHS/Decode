...
public class RobotContainer {
    ...
    public static GamepadEx controller1;
    public static GamepadEx controller2;
    ...
    public static void Init_TeleOp(CommandOpMode mode) {
        ...
        controller1.getGamepadButton(GamepadKeys.Button.BACK).whenPressed(new InstantCommand(()-> gyro.resetYawAngle(), gyro));
//        driverOp.getGamepadButton(GamepadKeys.Button.LEFT_BUMPER).toggleWhenPressed(new ToggleClaw());
    ...
    private static void Init() {
        ...
        // create gamepads
        controller1 = new GamepadEx(ActiveOpMode.gamepad1);
        controller2 = new GamepadEx(ActiveOpMode.gamepad2);
