...
public class Blue_FarNear {
        ...
        public static final Pose GATE_END_POSE = new Pose(17, 70.5, Math.toRadians(180));//new Pose(17, 72, Math.toRadians(180));
